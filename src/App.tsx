  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-3xl">
        ...
        <p className="text-gray-400 mb-8 text-sm">Upload the summary sheet to generate per-driver reports.</p>
        ...
        {step === 'upload' && (
          ...
          >
            ...
            {loading ? (
              ...
              <>
                <p className="text-lg font-medium mb-2">Drop summary Excel here</p>
          ...
          <div>
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-gray-400 text-sm">{groups.length} drivers · {groups.reduce((s, g) => s + g.trips.length, 0)} trips</p>
              </div>
              <button
                onClick={reset}
                  ...
                  {[...groups]
                    ...
                    .map((g, i) => (
                      <tr key={i} className="border-t border-gray-800 hover:bg-gray-900/50">
                        ...
                        <td className="px-4 py-3 text-right text-gray-400">{g.trips.length}</td>
                        <td className={`px-4 py-3 text-right font-mono font-medium
                          ${g.totalVariance < 0 ? 'text-green-400' : 'text-red-400'}`}>
                          {g.totalVariance > 0 ? '+' : ''}{g.totalVariance.toFixed(4)}
                        </td>
                      </tr>
                    ))}
                </tbody>
        ...
        {step === 'done' && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 text-sm mb-8">{monthLabel} — {groups.length} driver sheets + ranking</p>
            <button
              onClick={reset}
